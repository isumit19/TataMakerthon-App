...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String GALLERY_DIRECTORY_NAME = "Tata Makerthon";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCapturePicture = findViewById(R.id.captureImage);
    ...
    private void previewCapturedImage() {
        try {
            ...
            Intent intent=new Intent(MainActivity.this,Croped.class);
